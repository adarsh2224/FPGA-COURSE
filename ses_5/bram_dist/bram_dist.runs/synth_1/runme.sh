...
HD_PWD='C:/Users/adars/Desktop/ses_5/bram_dist/bram_dist.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log distributed_ram_256x32.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source distributed_ram_256x32.tcl
