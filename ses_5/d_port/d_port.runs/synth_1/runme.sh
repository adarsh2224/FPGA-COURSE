...
HD_PWD='C:/Users/adars/Desktop/ses_5/d_port/d_port.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log true_dual_port_ram_32x16k.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source true_dual_port_ram_32x16k.tcl
